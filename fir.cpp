...
void CLMS::Copy(CLMS &other)
{
	...
	m_lmsMU2 = other.m_lmsMU2;			// LMS 2��
	m_lmsGM = other.m_lmsGM;			// LMS ��
...
//---------------------------------------------------------------------
// ���g�������O���t�i�t�B���^�X���b�h���ŃR�[�����Ă͂����Ȃ��j
//
//	H(ej��T) = [��0]Hm cos(m��T) - j[��1]Hm sin(m��T)
//
