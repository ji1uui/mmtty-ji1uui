...
//
// CCtnc は ISerialDevice を実装することで、上位モジュールが
// CCtnc の具体クラスを知らなくてよくなる。
// Main.h は ISerialDevice* 経由で CComm/CCtnc/CCradio を統一操作できる。
//---------------------------------------------------------------------------
...
public:
	...
	void __fastcall PutRawChar(char c);               // 旧 PutChar(char) 後方互換ラッパー
