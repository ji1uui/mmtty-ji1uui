...
#include "ComLib.h"
//---------------------------------------------------------------------------
// SOLID P2: RAII wrapper for CRITICAL_SECTION — guarantees Leave even on
...
//---------------------------------------------------------------------------
#define WAVE_TIMEOUT_EVENT  2000		// �o�b�t�@���N�G�X�g�̃^�C���A�E�g
#define	WAVE_FIFO_MAX	    32			// �z�o�b�t�@�̍ő��
//---------------------------------------------------------------------------
class CWave
{
...
private:
	LPWAVEHDR    m_pInBuff[WAVE_FIFO_MAX];	// ���̓o�b�t�@
	LPWAVEHDR    m_pOutBuff[WAVE_FIFO_MAX];	// �o�̓o�b�t�@
	WAVEFORMATEX m_OWFX;		// �o�̓t�H�[�}�b�g
	WAVEFORMATEX m_IWFX;		// ���̓t�H�[�}�b�g
